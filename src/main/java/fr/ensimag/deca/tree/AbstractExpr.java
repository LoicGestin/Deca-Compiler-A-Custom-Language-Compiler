...
public abstract class AbstractExpr extends AbstractInst {
    ...
    public AbstractExpr verifyRValue(DecacCompiler compiler,
        ...
        if(!compiler.environmentType.compatible(expectedType, cour)) {
            throw new ContextualError("Incompatible types in assignment", getLocation());
        }
        setType(cour);
        return this;
    }
    ...
    void verifyCondition(DecacCompiler compiler, EnvironmentExp localEnv,
        ...
        if (!t.isBoolean()) {
            throw new ContextualError("Condition must be boolean", getLocation());
        }
    ...
    protected void codeGenPrint(DecacCompiler compiler) {
        compiler.addInstruction(new LOAD(1, compiler.getRegister(1)));
    }
